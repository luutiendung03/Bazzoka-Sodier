...
public class Shotgun_Bullet : Bullet
{
    ...
    public override IEnumerator Shoot(Bullet bullet, Vector2 point, Vector2 direction, float force)
    {
        ...
        newBullet.Push(Random.Range(force - 3, force + 3) * new Vector2(Mathf.Tan(Random.Range(a - 15, a + 15) * Mathf.Deg2Rad), 1));
        Bullet newBullet1 = Instantiate(bullet, point, Quaternion.identity);
        newBullet1.Push(Random.Range(force - 3, force + 3) * new Vector2(Mathf.Tan(Random.Range(a - 15, a + 15) * Mathf.Deg2Rad), 1));
        Bullet newBullet2 = Instantiate(bullet, point, Quaternion.identity);
        newBullet2.Push(Random.Range(force - 3, force + 3) * new Vector2(Mathf.Tan(Random.Range(a - 15, a + 15) * Mathf.Deg2Rad), 1));
        Bullet newBullet3 = Instantiate(bullet, point, Quaternion.identity);
        newBullet3.Push(Random.Range(force - 3, force + 3) * new Vector2(Mathf.Tan(Random.Range(a - 15, a + 15) * Mathf.Deg2Rad), 1));
        Bullet newBullet4 = Instantiate(bullet, point, Quaternion.identity);
        newBullet4.Push(Random.Range(force - 3, force + 3) * new Vector2(Mathf.Tan(Random.Range(a - 15, a + 15) * Mathf.Deg2Rad), 1));
    }
}
